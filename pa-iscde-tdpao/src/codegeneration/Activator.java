...
public class Activator implements BundleActivator {
	...
	private ServiceRegistration<CodeGenerationService> serviceRegistre;
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		serviceRegistre = context.registerService(CodeGenerationService.class, new CodeGenerationServiceImpl(), null);
